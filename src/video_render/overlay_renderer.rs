...
pub fn draw_overlay(
    ...
    let min_digits_width =
        text_renderer::measure_text_width_ttf("00000000000000000000000000000", font_size);

    let window_width = (max_text_width.max(min_digits_width) + (32.0 * scale) as i32)
        .max((200.0 * scale) as i32) as u32;
    ...
    for line in lines {
        ...
        if let Some(idx) = line.find(':') {
            ...
            text_renderer::draw_text_ttf(
                ...
                width,
                height,
                x + window_width as i32 - text_x_pad - value_width,
                text_y,
                value,
                text_color,
                font_size,
            ...
            if line.contains('/') && !line.starts_with("Time") {
                ...
                text_renderer::draw_text_ttf(
                    ...
                    width,
                    height,
                    x + (window_width as i32 - text_width) / 2,
                    text_y,
                    &line,
                    text_color,
                    font_size,

...
// border_width is constant for the whole frame, so it lives here instead of in
// every vertex. That keeps the vertex at 12 bytes rather than 16, which is a
// straight 25% off the per-frame vertex upload.
